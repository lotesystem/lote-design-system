  ...
  return (
    <div style={{ maxWidth: '960px', margin: '0 auto' }}>
      <Jumbotron fluid={fluid}>
        ...
        <Text tag="p">
          A simple jumbotron, using Text component prop named tag with value p.
          It will render text on the underlying Dom with a paragraph element.
        </Text>
        <Button tag="a" size="lg" href="/">
          Learn more
        </Button>
      </Jumbotron>
    </div>

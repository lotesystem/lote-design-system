        ...
        <div style={{maxWidth: '960px',padding: '16px', margin: '0 auto', border: '1px solid #ddd'}}>
            ...
            <ButtonToolbar>
                <ButtonGroup size={size} vertical={vertical}>
                    ...
                    <Button variation="outline" color="secondary">Edit</Button>
                    <Button variation="outline" color="success">Search</Button>
                    <Button variation="outline" color="warning">View</Button>
                    <Button variation="outline" color="danger">Encoding</Button>
                </ButtonGroup>
            </ButtonToolbar>
        </div>
    );

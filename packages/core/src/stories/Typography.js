...
export const simple = () => {
    return (
        <div style={{maxWidth: '760px', margin: '26px auto', padding: '0 30px'}}>
            ...
            <p>Using mark element <mark>highlight</mark> text.</p>
            <p><del>Deleted text.</del></p>
            <p><s>No longer accurate.</s></p>
            <p><ins>An addition to the document.</ins></p>
            <p><u>Render as underlined</u></p>
            <p><small>Treated as fine print.</small></p>
...
export const responsiveFont = () => {
    ...
    return (
        <div style={{maxWidth: '560px', margin: '26px auto',padding: '0 30px'}}>
            <p>Allowing text to scale more naturally across device and viewport sizes.
                Remember font-size is explicitly converted into `rem` unit with base 16 pixel size.
                To check real <b>Demo</b> Open the canvas in a new tab behind the scenes a media query is generated.
            </p>
            <Text fSize={ parseInt(num) }>
                Hello World
            </Text>
        </div>
    );

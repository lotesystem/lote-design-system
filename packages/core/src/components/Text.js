...
const rfs = (props) => {
    ...
    if (fSize > BASE_FONT_SIZE) {
        ...
        let fSizeMin =  BASE_FONT_SIZE + (fSize - BASE_FONT_SIZE) / FACTOR;

        // Calculate difference between given font-size and minimum font-size for given font-size
        let fSizeDiff = fSize - fSizeMin;
        ...
        let variableWidth = `${fSizeDiff * 100 / BREAKPOINT}${variableUnit}`;
    ...
    if (fFluid === null) {
       ...
       return css`font-size: ${fStatic}rem`;
    } else {

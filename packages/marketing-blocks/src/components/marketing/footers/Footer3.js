...
const colCopyrightSchema = {
  logo: <LogoDefault fill="#fff" circleFill="#3a3838" />,
...
export const Footer3 = props => {
  const { backgroundColor, colApi, colCopyright, cols, ...attributes } = props;
  const copyRight = modifiedCopyright(colCopyright);

  return (
    <FooterContent bgColor={backgroundColor} {...attributes}>
...
Footer3.propTypes = propTypes;
Footer3.defaultProps = defaultProps;
